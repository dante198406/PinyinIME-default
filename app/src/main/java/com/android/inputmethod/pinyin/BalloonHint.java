...
public class BalloonHint extends PopupWindow {
    ...
    private class BalloonView extends View {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int measuredWidth = Config.mPaddingLeft + Config.mPaddingRight;
            int measuredHeight = Config.mPaddingTop + Config.mPaddingBottom;
            if (null != mIcon) {
            ...
            int maxWidth = Environment.getInstance().getScreenWidth() -
                    Config.mPaddingLeft - Config.mPaddingRight;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (null != mIcon) {
                ...
                float x = Config.mPaddingLeft;
                x += (width - labelMeasuredWidth - Config.mPaddingLeft - Config.mPaddingRight) / 2.0f;
                String labelToDraw = mLabel;
                if (x < Config.mPaddingLeft) {
                    x = Config.mPaddingLeft;
                    labelToDraw = getLimitedLabelForDrawing(mLabel,
                            width - Config.mPaddingLeft - Config.mPaddingRight);
                }
